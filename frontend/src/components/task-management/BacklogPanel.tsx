...
import { getBacklogTasks } from '../../lib/api'
...
export default function BacklogPanel({ onRequestCreate, refreshSignal, onEditTask }: BacklogPanelProps) {
  ...
  // Refetch when the parent signals a new backlog task was created.
  useEffect(() => {
      ...
      <div ref={panelRef} className="relative inline-block" dir="rtl">
        ...
        {open && (
          <div className="absolute top-full mt-2 right-0 z-50 w-72 bg-white dark:bg-gray-800 border border-indigo-200 dark:border-indigo-700 rounded-xl shadow-xl overflow-hidden">
            ...
            {/* Create trigger — delegates to the shared create-task modal */}
