...
from backend.api.v1.cems_deps import get_current_user, get_db, require_admin_or_manager, require_any_cems_role, check_warehouse_manager_access
from backend.models.cems_transfer import ReturnStatus, TransferStatus
...
from backend.schemas.cems_transfer import (
...
from backend.services.cems_return_service import ReturnService
...
async def approve_return(
    ...
    from backend.models.cems_transfer import WarehouseReturn as WarehouseReturnModel
